...
<template>
  ...
  <div class="bg-gray-50 min-h-screen">
    <div class="max-w-[1400px] mx-auto py-8 sm:py-12 px-4">
      <!-- Main Content -->
      <div class="text-center mb-6 sm:mb-8">
        <div class="w-16 h-16 sm:w-20 sm:h-20 bg-orange-100 flex items-center justify-center mx-auto mb-4 sm:mb-6">
        ...
        <h1 class="text-2xl sm:text-3xl font-bold text-gray-900 mb-2 sm:mb-3">Volunteer Access Required</h1>
        <p class="text-base sm:text-lg text-gray-600 mb-6 sm:mb-8">You need to be an approved volunteer to access this feature.</p>
      </div>
      ...
      <div class="bg-white border border-gray-200 p-4 sm:p-6 mb-6 sm:mb-8">
        <div v-if="!userName" class="text-center">
          <h2 class="text-lg sm:text-xl font-semibold text-gray-900 mb-2.5 sm:mb-3">Please Log In</h2>
        ...
        <div v-else-if="volunteerStatus === 'No Application'" class="text-center">
          <h2 class="text-lg sm:text-xl font-semibold text-gray-900 mb-2.5 sm:mb-3">Become a Volunteer</h2>
          <p class="text-sm sm:text-base text-gray-600 mb-4 sm:mb-6">
        ...
        <div v-else-if="volunteerStatus === 'Pending'" class="text-center">
          <h2 class="text-lg sm:text-xl font-semibold text-gray-900 mb-2.5 sm:mb-3">Application Under Review</h2>
          <p class="text-sm sm:text-base text-gray-600 mb-4 sm:mb-6">
        ...
        <div v-else-if="volunteerStatus === 'Rejected'" class="text-center">
          <h2 class="text-lg sm:text-xl font-semibold text-gray-900 mb-2.5 sm:mb-3">Application Rejected</h2>
          <p class="text-sm sm:text-base text-gray-600 mb-4 sm:mb-6">
      ...
      <div class="bg-white border border-gray-200 p-4 sm:p-6">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4">
          ...
          >
            ...
            <div class="text-xs sm:text-sm font-medium text-gray-900">View Cases</div>
          </Link>
          ...
          >
            ...
            <div class="text-xs sm:text-sm font-medium text-gray-900">Report Case</div>
          </Link>
          ...
          <Link 
            ...
            class="text-center p-3 sm:p-4 border border-gray-200 hover:bg-gray-50 transition-colors"
          >
            <div class="w-6 h-6 sm:w-8 sm:h-8 bg-orange-100 flex items-center justify-center mx-auto mb-1.5 sm:mb-2">
            ...
            <div class="text-xs sm:text-sm font-medium text-gray-900">Become Volunteer</div>
          </Link>
