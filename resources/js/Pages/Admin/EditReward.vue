      ...
      <form @submit.prevent="submit" class="space-y-6">
        ...
        <div class="flex gap-4 pt-2">
          <button
            ...
            class="flex-1 bg-gray-900 text-white py-3 px-4 rounded-lg font-medium hover:bg-black disabled:opacity-60 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 transition-colors"
          >
