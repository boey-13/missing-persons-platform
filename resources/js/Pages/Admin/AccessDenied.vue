  ...
  <div class="bg-gray-50 min-h-screen">
    <div class="max-w-3xl mx-auto py-12 px-4">
      ...
      <div class="text-center mb-8">
        <div class="w-20 h-20 bg-red-100 flex items-center justify-center mx-auto mb-6">
          <svg class="w-10 h-10 text-red-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"></path>
          </svg>
        </div>
        
        <h1 class="text-3xl font-bold text-gray-900 mb-3">Admin Access Required</h1>
        <p class="text-lg text-gray-600 mb-8">You don't have permission to access the admin panel.</p>
      </div>
      ...
      <div class="bg-white border border-gray-200 p-6 mb-8">
        <div v-if="userRole === 'user'" class="text-center">
          <h2 class="text-xl font-semibold text-gray-900 mb-3">Welcome to FindMe!</h2>
        ...
        <div v-else-if="userRole === 'volunteer'" class="text-center">
          <h2 class="text-xl font-semibold text-gray-900 mb-3">Volunteer Dashboard</h2>
          <p class="text-gray-600 mb-6">
          ...
          <div class="flex flex-col sm:flex-row gap-4 justify-center">
            <Link 
              ...
              class="inline-flex items-center px-6 py-3 bg-purple-600 text-white font-medium hover:bg-purple-700 transition-colors"
            >
              Browse Projects
            </Link>
            <Link 
      ...
      <div class="bg-white border border-gray-200 p-6">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          >
            ...
            <div class="text-sm font-medium text-gray-900">Report Missing Person</div>
          </Link>
          ...
          >
            ...
            <div class="text-sm font-medium text-gray-900">Report Sighting</div>
          </Link>
          ...
          <Link 
            ...
            class="text-center p-4 border border-gray-200 hover:bg-gray-50 transition-colors"
          >
            <div class="w-8 h-8 bg-yellow-100 flex items-center justify-center mx-auto mb-2">
              <svg class="w-4 h-4 text-yellow-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1"></path>
              </svg>
            </div>
            <div class="text-sm font-medium text-gray-900">Browse Rewards</div>
          </Link>
