...
function goBack() {
  router.visit('/admin/missing-reports')
}
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-1">
          <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <h2 class="text-xl font-semibold text-gray-900 mb-4">Missing Person Details</h2>
            ...
            <div class="space-y-3">
              <div>
                ...
                <div class="text-gray-900">{{ missingReport.full_name }}</div>
              </div>
              <div>
            ...
            <form @submit.prevent="createProject" class="space-y-6">
              ...
              <div class="flex gap-4 pt-6 border-t border-gray-200">
                <button
                  ...
                  class="flex-1 bg-blue-600 text-white py-3 px-4 rounded-lg font-medium hover:bg-blue-700 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-colors disabled:opacity-50 relative"
                >
                  <span v-if="projectForm.processing" class="absolute inset-0 flex items-center justify-center">
                    <svg class="animate-spin h-4 w-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                      <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                      <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                    </svg>
                  </span>
                  <span :class="{ 'opacity-0': projectForm.processing }">
