              ...
              <form @submit.prevent="updateLatestNews" class="space-y-4">
                ...
                <div class="flex justify-end gap-3">
                  ...
                  <button
                    ...
                    class="px-4 py-2 rounded-lg bg-blue-600 text-white font-medium hover:bg-blue-700 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition disabled:opacity-50 relative"
                  >
