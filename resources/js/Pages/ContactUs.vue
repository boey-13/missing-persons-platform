          ...
          <div>
            ...
            <form @submit.prevent="submitForm" class="space-y-6">
              ...
              <button
                ...
                class="w-full bg-[#5C4033] text-white py-3 px-6 rounded-lg font-semibold hover:bg-[#4c352b] transition-colors disabled:opacity-50 disabled:cursor-not-allowed relative"
              >
